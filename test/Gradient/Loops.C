...
//CHECK-NEXT:     double f_log_gaus_return = std::log(_t19);
//CHECK-NEXT:     goto _label0;
//CHECK-NEXT:   _label0:
//CHECK-NEXT:     {
//CHECK-NEXT:         double _r17 = 1 * custom_derivatives::log_darg0(_t19);
...
//CHECK-NEXT:         double _r9 = _r8 * custom_derivatives::sqrt_darg0(_t16);
//CHECK-NEXT:         double _r10 = _r9 * _t12;
//CHECK-NEXT:         double _grad2 = 0.;
//CHECK-NEXT:         double _grad3 = 0.;
//CHECK-NEXT:         custom_derivatives::pow_grad(_t13, _t14, &_grad2, &_grad3);
...
//CHECK-NEXT:         double _r16 = _r15 * custom_derivatives::exp_darg0(_t18);
...
//CHECK-NEXT:         double _grad0 = 0.;
//CHECK-NEXT:         sq_grad(clad::pop(_t5), &_grad0);
//CHECK-NEXT:         double _r0 = _r_d0 * _grad0;
//CHECK-NEXT:         int _t2 = clad::pop(_t1);
...
// CHECK-NEXT:         }
// CHECK-NEXT:     double fn7_return = a;
// CHECK-NEXT:     goto _label0;
// CHECK-NEXT:   _label0:
// CHECK-NEXT:     _d_a += 1;
...
// CHECK-NEXT:             } while (--counter);
// CHECK-NEXT:         }
// CHECK-NEXT:     double fn8_return = a;
// CHECK-NEXT:     goto _label0;
// CHECK-NEXT:   _label0:
// CHECK-NEXT:     _d_a += 1;
// CHECK-NEXT:     while (_t0)
...
// CHECK-NEXT:                 }
// CHECK-NEXT:         }
// CHECK-NEXT:     double fn9_return = a;
// CHECK-NEXT:     goto _label0;
// CHECK-NEXT:   _label0:
// CHECK-NEXT:     _d_a += 1;
// CHECK-NEXT:     while (_t0)
...
// CHECK-NEXT:         }
// CHECK-NEXT:     double fn10_return = a;
// CHECK-NEXT:     goto _label0;
// CHECK-NEXT:   _label0:
// CHECK-NEXT:     _d_a += 1;
// CHECK-NEXT:     while (_t0)
...
// CHECK-NEXT:         counter -= 1;
// CHECK-NEXT:     } while (counter);
// CHECK-NEXT:     double fn11_return = a;
// CHECK-NEXT:     goto _label0;
// CHECK-NEXT:   _label0:
// CHECK-NEXT:     _d_a += 1;
// CHECK-NEXT:     do {
...
// CHECK-NEXT:         counter -= 1;
// CHECK-NEXT:     } while (counter);
// CHECK-NEXT:     double fn12_return = a;
// CHECK-NEXT:     goto _label0;
// CHECK-NEXT:   _label0:
// CHECK-NEXT:     _d_a += 1;
// CHECK-NEXT:     do {
...
// CHECK-NEXT:         res += temp;
// CHECK-NEXT:     }
// CHECK-NEXT:     double fn13_return = res;
// CHECK-NEXT:     goto _label0;
// CHECK-NEXT:   _label0:
// CHECK-NEXT:     _d_res += 1;
// CHECK-NEXT:     for (; _t0; _t0--) {
